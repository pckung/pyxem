...
from pyxem.utils._flucor import _spatial_local_bkg_calc, _log_bkg_removal
...
if TYPE_CHECKING:
    ...
    from pyxem.signals.differential_diffraction2d import DifferentialDiffraction2D
