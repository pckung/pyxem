...
class InSituPolarDiffraction2D(PolarDiffraction2D, InSituDiffraction2D):
    ...
    **kwargs:
    ...
    def expected_polar_intensity(
            self,
            method: Literal["tazi_local", "tazi", "azi", "azi_local", "t", "k"] = "tazi_local",
        ...
        Parameters
        ----------
        method : Literal["tazi_local", "tazi", "azi", "azi_local", "t", "k"], default="tazi_local"
        ...
        if method == "tazi_local":
            ...
            _method = "k"
        elif method == 'azi_local':
            _method = "custom"
            custom_axes = {}
            custom_axes['full_axis'] = None
            custom_axes['local_axis'] = [2]
            azi_size = int(local_azi_angle / 360.0 * self.axes_manager.signal_axes[0].size)
            if azi_size % 2 == 0:
                azi_size += 1
