...
def _bkg_calc(
    ...
    **kwargs,
    ...
    center : Literal["mean", "median"], optional
        The method to use for calculating the background. "mean" uses the mean, while "median" uses the median. By default, it is set to "mean".
    **kwargs : dict
